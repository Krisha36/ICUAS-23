...
(cl:in-package icuas23_competition-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <poi>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'poi)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name icuas23_competition-msg:<poi> is deprecated: use icuas23_competition-msg:poi instead.")))

(cl:ensure-generic-function 'poi-val :lambda-list '(m))
(cl:defmethod poi-val ((m <poi>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icuas23_competition-msg:poi-val is deprecated.  Use icuas23_competition-msg:poi instead.")
  (poi m))
