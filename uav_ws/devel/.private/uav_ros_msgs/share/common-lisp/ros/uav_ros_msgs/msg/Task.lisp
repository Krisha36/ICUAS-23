...
(cl:defmethod cl:initialize-instance :after ((m <Task>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Task)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name uav_ros_msgs-msg:<Task> is deprecated: use uav_ros_msgs-msg:Task instead.")))
...
(cl:defmethod id-val ((m <Task>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_ros_msgs-msg:id-val is deprecated.  Use uav_ros_msgs-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Task>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_ros_msgs-msg:name-val is deprecated.  Use uav_ros_msgs-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <Task>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_ros_msgs-msg:type-val is deprecated.  Use uav_ros_msgs-msg:type instead.")
  (type m))

(cl:ensure-generic-function 'timeout-val :lambda-list '(m))
(cl:defmethod timeout-val ((m <Task>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_ros_msgs-msg:timeout-val is deprecated.  Use uav_ros_msgs-msg:timeout instead.")
  (timeout m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<Task>)))
    "Constants for message type '<Task>"
  '((:PICKUP_TASK . "\"PickupTask\"")
    (:DROPOFF_TASK . "\"DropoffTask\""))
)
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql 'Task)))
    "Constants for message type 'Task"
  '((:PICKUP_TASK . "\"PickupTask\"")
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Task>)))
  ...
  "b9cc75d829ee178c7d523616d41bda34")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Task)))
  "Returns md5sum for a message object of type 'Task"
  "b9cc75d829ee178c7d523616d41bda34")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Task>)))
  ...
  (cl:format cl:nil "string PICKUP_TASK = \"PickupTask\"~%string DROPOFF_TASK = \"DropoffTask\"~%~%std_msgs/Header header~%int32 id~%string name~%string type~%float64 timeout~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Task)))
  "Returns full string definition for message of type 'Task"
  (cl:format cl:nil "string PICKUP_TASK = \"PickupTask\"~%string DROPOFF_TASK = \"DropoffTask\"~%~%std_msgs/Header header~%int32 id~%string name~%string type~%float64 timeout~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
