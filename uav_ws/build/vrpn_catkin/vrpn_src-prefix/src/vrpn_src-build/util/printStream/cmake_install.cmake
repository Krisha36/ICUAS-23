# Install script for directory: /root/uav_ws/build/vrpn_catkin/vrpn_src-prefix/src/vrpn_src/util/printStream
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xclientsx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/root/uav_ws/build/vrpn_catkin/vrpn_src-prefix/src/vrpn_src-build/util/printStream/vrpn_streamPrint")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/vrpn_streamPrint" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/vrpn_streamPrint")
